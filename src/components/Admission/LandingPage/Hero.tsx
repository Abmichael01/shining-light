...
export default function Hero() {
  return (
    <SectionPadding className='relative h-[400px] overflow-hidden flex items-center justify-center'>
        <img src="/admission-is-open.jpg" alt="graduation-pic" className='absolute inset-0 w-full h-full object-cover' />
        ...
        <div className="relative z-[2] flex flex-col items-center text-center text-white  font-fancy gap-10">
            ...
            <GlidingButton className='px-10 font-semibold' line={false}>Apply Now</GlidingButton>
        </div>
    </SectionPadding>
  )
}
